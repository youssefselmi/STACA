...
<tr>
<td>ID BEST</td>
<td><input type="number" name="idbest" value="<?PHP echo $id_best ?>"></td>
</tr>
<tr>
<td>ID CUSTOMER</td>
<td><input type="number" name="idclients" value="<?PHP echo $id_client ?>"></td>
</tr>
<tr>
<td>NAME</td>
...
if (isset($_POST['modifier'])){
	...
	header('Location:Top_customers.php');
}
?>
                                        </div>
                                            </div>
