                            ...
                            <div class="col-sm-12">
                                <div class="panel-box">
                                    ...
                                    <table class="table table-striped table-hover" id="">
                                       <thead>   
                                     <td>   <select class="input-select" size="1" onChange="location = this.options[this.selectedIndex].value;" class="form-control">
										...
										<option value="affichageclient.php?clientTriesZ=1">Z-A</option> </td>
									</select>
                                   </tr>
                                   </thead>
                                   <thead> 
                            ...
                            <div class="col-sm-12">
                                <div class="panel-box">
                                    ...
                                    <table class="table table-striped table-hover" id="myTable">
                                        <thead>
                                        <tr><input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for Adress.." title="Type in a name" class="form-control"></tr>
                                            <tr>
                                            <th>ID</th>
                                                <th>Adress</th>
                                                <th>Postal code</th>
