...
$db=config::getConnexion();
   ...
   $req1= $db->query("SELECT sum(qte) as tot,id_produit as product, MONTHNAME(date_vente) as date_de_vente from ventes_produits GROUP BY MONTHNAME(date_vente)");
   $req1->execute();
