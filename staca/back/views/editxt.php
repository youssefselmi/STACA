...
<!-- Mirrored from html.designstream.co.in/pink-desh/dark/mail_compose.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 07 Nov 2019 01:41:25 GMT -->
<head>
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="panel-box">
                                    <a href="#" class="btn btn-lg btn-danger btn-block">Compose Email</a>
                       ...
                       <div class="col-md-9 compose_form">
                            <form role="form">
                                ...
                                <div>
                                    <form name="f">
                                 <select>
                                     <option name="colortxt"> White </option>
                                     <option name="colortxt"> Grey </option>
                                     <option name="colortxt"> Red </option>
                                     <option name="colortxt"> Blue </option>
                                 </select>
                                 </form>
                                </div>
                                ...
                                <div class="form-group">
                                    <textarea id="wysiwyg" placeholder="Your message here..." class="form-control" rows="20" style="<?php if($row['statut']=='Delivred') { $color='green'; } ?>"></textarea>
                                </div>
                                <div class="form-group">
...
<!-- Mirrored from html.designstream.co.in/pink-desh/dark/mail_compose.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 07 Nov 2019 01:41:27 GMT -->
</html>
