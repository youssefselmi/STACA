...
$db=config::getConnexion();
   ...
   $req1= $db->query("SELECT nom as names,nbr_ventes as ventes from best_sellers");
   $req1->execute();
...
foreach ($liste as $row) {
    $dataPoints[] = array('label' => $row->names, 'y' => $row->ventes);
}
?>
