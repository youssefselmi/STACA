  ...
  <div class="col-md-9 compose_form" >
                            <form role="form" >
                                <div class="form-group">
                                    <input type="text" class="form-control" placeholder="To:" readonly="" value="<?PHP echo $email; ?>"  >
                                </div>
                              
                                 <div class="form-group">
                                    <input readonly type="text" class="form-control" name="objet" placeholder="Subject:" value="<?PHP echo $objet;?>">
                                </div>
                                <div class="form-group">
                                    <textarea  readonly id="wysiwyg" placeholder="Your message here..." class="form-control" rows="20" name="message" > <?PHP echo $message;?> </textarea>
                                </div>
