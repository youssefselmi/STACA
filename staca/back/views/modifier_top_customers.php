...
if (isset($_GET['id_best'])){
	$top_cust=new customerC();
    $result=$top_cust->recuperer_customer($_GET['id_best']);
	foreach($result as $row){
		$id_best=$row['id_best'];
		$id_client=$row['id_client'];
		$nom=$row['nom'];
		$prenom=$row['prenom'];
		$nbr_visites=$row['nbr_visites'];
                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li class="active">
                        ...
                        <li><i class="fa fa-bar-chart-o"></i> <span>PRODUCTS STATS</span><span class="fa arrow"></span></li> <!-- graph flot-->
                            ...
                            <li><a href="graph_chartist.html">Chartist</a></li><!-- graph flot-->
                        </ul>
                    </li>
                    <li>
...
<caption>Modify Customer Views </caption>
<tr>
<td>ID BEST</td>
<td><input  type="number" name="idbest" readonly  value="<?PHP echo $id_best ?>"></td>
</tr>
<tr>
<td>ID CUSTOMER</td>
<td><input type="number" name="idclients" readonly value="<?PHP echo $id_client ?>"></td>
</tr>
<tr>
<td>NAME</td>
...
<tr>
<td>LAST NAME</td>
<td><input type="texte" name="prenom" value="<?PHP echo $prenom ?>"></td>
</tr>
<tr>
<td>VISITS NUMBER</td>
<td><input type="number" name="nbrvisites" value="<?PHP echo $nbr_visites ?>"></td>
</tr>
<tr>
<td></td>
<td><input  style="margin-left: 4%" type="submit" class=" btn btn-theme btn-lg" name="modifier" value="modify"></td>
</tr>
<tr>
<td></td>
<td><input type="hidden" name="id_ini" value="<?PHP echo $_GET['id_best'];?>"></td>
</tr>
</table>
</form>
<?PHP
...
if (isset($_POST['modifier'])){
	$customerCC=new customer($_POST['idbest'],$_POST['idclients'],$_POST['nom'],$_POST['prenom'],$_POST['nbrvisites']);
	$top_cust->modifier_customer($customerCC,$_POST['id_ini']);
	echo("<script> window.location.replace(\"Top_customers.php\")</script>");
}
?>
                                        </div>
                                            </div>
