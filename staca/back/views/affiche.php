...
<!-- Mirrored from tm-shopify048-wheels.myshopify.com/collections/all by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 06 Nov 2019 22:14:56 GMT -->
...
<head>
    ...
    <title>Products | Wheels &amp; Tyres</title>
...
<link rel="alternate" type="application/atom+xml" title="Feed" href="all.atom" />
<link rel="next" href="all4658.html?page=2">
...
<script id="__st">var __st={"a":5086409,"offset":-18000,"reqid":"50b57712-10f3-41be-8636-c9e2f49dbde9","pageurl":"tm-shopify048-wheels.myshopify.com\/collections\/all","u":"ba37d268ac1c","p":"collection"};</script>
    ...
    if (!isDuplicatedThankYouPageView()) {
      setCookieIfThankYouPage();
        ...
        window.ShopifyAnalytics.lib.track(
          ...
          {"currency":"USD","category":"Collection: all","nonInteraction":true}
        );
...
<nav role="navigation">
    ...
    <li class=" active has-dropdown">
        <a href="all.html" title="">Products</a>
        
        <ul>
        
        
            <li class=" first"><a class="first" href="wheels.html">Wheels</a></li>
        
            <li class=""><a class="" href="accessories.html">Accessories</a></li>
        
            <li class=""><a class="" href="sport-tyres.html">Sport Tyres</a></li>
        
            <li class=""><a class="" href="winter-tyres.html">Winter Tyres</a></li>
        
            <li class=" last"><a class="last" href="summer-tyres.html">Summer Tyres</a></li>
...
<div class="product_img">  
    <a href="accessories/products/ats-classic.html">
    	<img src="image/<?PHP echo $row['image'];  ?>" alt="ATS Classic" />
    </a>
</div>

<div class="product_info">
    <div class="product_name">
        <a href="accessories/products/ats-classic.html"><?PHP echo $row['nom']; ?></a>
    </div>
...
if ($prix!=-1){
  ...
  ?>       
        <span class="money"><?PHP echo $prix; ?>TND <br><del> <?PHP echo $row['prix']; ?>    TND  </del></span>

<?php } else { ?>

<span class="money"> <?PHP echo $row['prix']; ?>    TND  </span><?php } ?>
...
<!-- Mirrored from tm-shopify048-wheels.myshopify.com/collections/all by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 06 Nov 2019 22:15:08 GMT -->
</html>