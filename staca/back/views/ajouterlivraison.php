                ...
                <div class="content">
                    <div class="container">
                        <div class="page-titleclicked">
                            <h3>Delivery</h3>
                            <a href="livraison.php"><i class="fa fa-plus"></i>Add Delivery</a>
                        </div><!--end page title-->
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="panel-box">
...
?>
                                            <tr>
                                                ...
                                                <td><?php echo $row['phone']; ?></td>
                                                    ...
                                                    <td> <a href="modifierlivraison.php?id=<?PHP echo $row['id']; ?>" style="float:left;">
                                                        <?php if($row['statut']!='Delivred'){?>modifier <?php } ?> </a>
     ...
     <h3>Add Delivery</h3>
        ...
        <td><input type="date" name="day" required id="datefield" min="1899-01-01"></td>
     </tr>
       ...
       <tr>
        ...
        <td><input type="number" name="phone" required min="20000000" max="99999999" ></td>
    </tr>

            <tr>
        <td></td>
        <td><button type="submit" value="ajouter" onclick="test()" name="lajout">ajouter</button></td>
    </tr>
...
function test()
        {
$phone=$_POST['phone'];
$phonelen=phone_strlen((string)$num); 
if($phonelen<8)
{
    echo("8 DIGITS !!");
}
