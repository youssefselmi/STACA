...
$sql='SELECT * FROM livreur LIMIT ' . $this_page_first_result . ',' .  $results_per_page;
$result = mysqli_query($con, $sql);
...
<button type="submit" name="supprimer">Delete</button>
  ...
  echo '<button class="au-btn-filter"><a href="livreur.php?page=' . $page . '">' . $page . '</a></button>';
}
 ?> 
