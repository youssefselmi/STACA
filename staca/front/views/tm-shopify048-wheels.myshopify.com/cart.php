...
$query->execute();
$data3=$query->fetch();
$_SESSION['idprod']=$data3['idproduit'];
$_SESSION['pt']=$data3['prixtotale'];

$_SESSION['qt']=$data3['quantite'];
...
echo $occ;
             ?></span></span><span>item(s)</span><span>&nbsp;&ndash;&nbsp;</span><span class="money cart-total-price"><?php
$host='localhost';
$user2='root';
$pass='';
$db='staca';
...
echo "<tr><th><h1> You choose <h1> </th></tr>"; 
while ($data=$query->fetch()) 
  {
echo "<form action='deletecart.php' method='post' >";
echo "<input class='trash' hidden readonly name='idtest' value=";
echo $data['idproduit'].">";
echo "<tr>";
echo "<th>";

echo "<h1>";
echo "product  ".$occ.":</br>".$data['nomprod'];
echo "</h1>";
echo "</th>";
echo "<th>";
echo "<input type='submit' class='btn btn-border-white' value='Remove from cart' name=''>";
echo "</tr>";
echo "</form>";
$occ++;
}
...
<table class="lol">
<tr>
<th><h1 class="aza">Adresse:</h1></th><th><input name="adress" type="text" placeholder="" class="ines" /></th>
</tr>
<tr>  
<th><h1>email:</h1></th><th><input  name="email" type="email" placeholder="" class="ines" /></th>
</tr>
<tr>  
<th><h1>Telephone:</h1></th><th><input  name="telephone" type="number" placeholder="" class="ines" /></th>
</tr>
<tr>  
<th><h1>Prix</h1></th><th><h1><?php
$host='localhost';
$user2='root';
$pass='';
$db='staca';
...
<tr><th><input type="submit" class="btn btn-border-white" value="envoyer" name=""></th></tr>
</table>  
</form>
