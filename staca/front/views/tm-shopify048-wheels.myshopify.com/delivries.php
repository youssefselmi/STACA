                                              ...
                                              <td ><span <?php if($row['statut']=='Delivred') { $color='green'; } else if($row['statut']=='Comfirming') { $color='grey'; }
                                               ...
                                               ?> style="color:<?php echo $color?>;" 
                                                ...
                                                <td <?php if($row['statut']=='Delivring') { ?> >
                                                  <button type="submit" name="track" value="track" onclick="tracking()" style="color:white; font-weight: bold;"> TRACK <?php } } ?> </button></td>
                                               ...
                                               <?php } ?>
                                                 <script type="text/javascript">
                                                  function tracking()
                                                  {
                                                  window.location.replace("tracked.php");
                                                  }
                                              </script>
