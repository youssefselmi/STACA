...
session_start();
include "../../config.php";
include "customerC1.php";
$db=config::getConnexion();

$req= $db->query("DELETE from tab2");
$req->execute();
$prod=new customerC();
$prod->top_prod();
   ...
   $liste1= $db->query("SELECT  prix,nom,image from tab2");
...
<!-- Mirrored from tm-shopify048-wheels.myshopify.com/pages/about-us by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 06 Nov 2019 22:16:14 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
    
    <meta name="description" content="Lorem ipsum dolor sit amet Explicabo repudiandae vitae accusamus excepturi fuga tenetur assumenda est in ipsam natus. Sapiente, iure vel dolorem consequuntur quidem ipsa eaque numquam vitae ratione doloremque hic quam iste earum reprehenderit aperiam quas accusantium perferendis eveniet ipsum repudiandae sequi reiciend" />
    
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1" />

    
    <title>About Us | STACA</title>
...
<script id="__st">var __st={"a":5086409,"offset":-18000,"reqid":"930c9bd7-096f-44c5-8425-788fea253087","pageurl":"tm-shopify048-wheels.myshopify.com\/pages\/about-us","s":"pages-17181443","u":"9bbc26399160","p":"page","rtyp":"page","rid":17181443};</script>
<script>window.ShopifyPaypalV4VisibilityTracking = true;</script>
<script>window.ShopifyAnalytics = window.ShopifyAnalytics || {};
window.ShopifyAnalytics.meta = window.ShopifyAnalytics.meta || {};
window.ShopifyAnalytics.meta.currency = 'USD';
var meta = {"page":{"pageType":"page","resourceType":"page","resourceId":17181443}};
    ...
    if (!isDuplicatedThankYouPageView()) {
      setCookieIfThankYouPage();
        ...
        window.ShopifyAnalytics.lib.page(
          null,
          {"pageType":"page","resourceType":"page","resourceId":17181443}
        );
...
<div class="header_row_2">
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <!-- HEADER CART -->
          	   <div class="header_cart"><a href="cart.html"><i class="fa fa-shopping-cart"></i><b>Cart:</b><span class="cart-total-items"><span class="count"><?php
...
echo $occ;?></span></span><span>item(s)</span><span>&nbsp;&ndash;&nbsp;</span><span class="money cart-total-price"><?php
$host='localhost';
$user2='root';
$pass='';
$db='staca';
...
{
$occ=$occ+$data['quantite'];
$prix=$prix+$data['quantite']*$data['prixtotale'];
}
echo $prix."DT";
?></span></a></div>
...
<div class="row">
<h1  align="center" style="font-size:30px ; font-weight: bolder;color:#f2d13e;">STACA</h1>
<h2 style="font-size:26px ;">WHO ARE WE?</h2>
<p style="font-size:18px ; font-weight: bold;">STACA or Société Tunisienne d’automobiles coréennes et Asiatique" is a society created  that works in car parts echanges created by Ala Dhhibi .
We are working with different Asian brands as KIA,SSangyong,Hyundai and Mahindra. </p>
<h2  style="font-size:26px ;" >SHIPPING</h2>
<p  style="font-size:18px ; font-weight: bold;">We ship to anywhere in Tunisia and if you spend over 100DT delivery is free.
</br>
our details:
</br>
Run Auto Parts</br>
(ABN 83 158 623 691)</br>
PO Box 471</br>
Mentone 3194</p>
<h2 style="font-size:26px ;">WHERE TO FIND US</h2>
<p  style="font-size:18px ; font-weight: bold;">Who can be bothered with the endless phone calls and emails searching for spare parts? Run Auto Parts is an Tunisian owned company based in bardo, but so we can give you the lowest prices possible, our store is online. Not only can you search for parts and information in one place, but you can also leave on your trackies and shop anytime from your lounge room or even your garage.</p>
  <h2  style="font-size:26px ;" >BRANDS</h2>
<div>

  <img style="width: 350px; height: 200px; margin-bottom: 30px; margin-right: 50px; "src="../image/kia">
  <img style="width: 350px; height: 200px; margin-bottom: 30px; margin-right: 50px;" src="../image/hyundai">
  <img style="width: 350px; height: 200px; margin-bottom: 30px; margin-right: 50px;" src="../image/ssangyong">
   <img style="width: 350px; height: 200px; margin-bottom: 30px;" src="../image/mahindra">
    ...
    <div class="product_listing_sidebar">
          ...
          <?php
            ...
            foreach($liste1 as $row){
              ?>
                <div class="product_img" style="width:50px; height: 50px;">    
                    <image src="../image/<?php echo $row['image'];?>"/>
                </div>
              <div class="product_info" style="width: 100px; height: 100px;">
                <div class="product_name">
                    <a><?php echo $row['nom']?></a>
                </div>
...
<!-- Mirrored from tm-shopify048-wheels.myshopify.com/pages/about-us by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 06 Nov 2019 22:16:17 GMT -->
</html>