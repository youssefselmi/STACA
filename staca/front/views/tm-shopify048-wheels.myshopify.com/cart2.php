...
<!-- Mirrored from tm-shopify048-wheels.myshopify.com/cart by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 06 Nov 2019 22:14:44 GMT -->
...
<head>
    ...
    <title>Your Shopping Cart | STACA</title>
...
<script id="__st">var __st={"a":5086409,"offset":-18000,"reqid":"17aac52b-3584-46e7-a2a2-22fcac481c2f","pageurl":"tm-shopify048-wheels.myshopify.com\/cart","u":"58f0d6f05468"};</script>
...
<div class="page_header">
  <h1 class="page_heading">Deliveries</h1>
</div>  
...
<div id="contactFormWrapper">
    ...
    <div class="row">
                              <form method="POST" action="ajouterlivraison2.php" name="f">
                                <table class="table" style="">


 <tr>
                                                <td>Product</td>
                                                <td> <input class="form-control" name="ref" value="<?php echo $_SESSION['idprod']; ?>" readonly></td>
                                              </tr>
                                              <tr>
                                                <td>Total</td>
                                               <td> <input  class="form-control" name="price" value="<?php echo $_SESSION['pt']; ?>" readonly></td>

                                              </tr>
                                                         <tr>
                                                <td>Quantity</td>
                           <td><input  class="form-control" style="color:black;" type="text" name="idc"  value="<?php echo $_SESSION['qt']; ?>" readonly></td>
        ...
        <td><input  class="form-control" style="color:black;" type="text" name="adress" value="<?php echo $_SESSION['ad'];?>" readonly></td>
    </tr>
  </div>
        ...
        <td><input type="date" name="day" required id="datefield" min="1899-01-01" style="color:white; background-color:#222427;"></td>
    </tr> -->
...
<!--      
        ...
        <td><input type="text" name="delivery_man" required></td>
    </tr>
    ...
    -->
        ...
        <td><input class="form-control" type="number" name="code_postal" required=""></td>
    </tr>
  </div>
<!--
       <tr>
...
<!--
    ...
    -->  
        ...
        <td><input  class="form-control" style="color:black;"  type="number" name="phone" min="20000000" max="99999999" value="<?php echo $_SESSION['tl'];?>" readonly ></td>
    </tr>

            <tr>
        <td><a href="delivries.php" style="color: orange;">Check my deliveries</a></td>
        <td><button type="submit" value="ajouter" onclick="test()" name="lajout" style="color:white; float: right">ADD</button></td>
                <td></td>
...
<!-- Mirrored from tm-shopify048-wheels.myshopify.com/cart by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 06 Nov 2019 22:14:56 GMT -->
</html>