...
<!-- Houni -->
 <table  class="table" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                <th style="font-weight: bold; color: grey; font-size: 20px;">Product Ref</th>
                                                <th style="font-weight: bold; color: grey; font-size: 20px;">ID</th>
                                                <th style="font-weight: bold; color: grey; font-size: 20px;">Price</th>
                                                <th style="font-weight: bold; color: grey; font-size: 20px;">Client Phone</th>
                                                <th style="font-weight: bold; color: grey; font-size: 20px;">State</th>
...
?>
                                            <tr>
                                              ...
                                              <td ><span <?php if($row['statut']=='Delivred') { $color='green'; } else if($row['statut']=='Comfirming') { $color='grey'; }
                                              else if($row['statut']=='Canceled') { $color='red'; }
                                              else if($row['statut']=='Delivring') { $color='orange'; }
                                               ?> style="color:<?php echo $color?>;" 
                                                ><?php echo $row['statut']; ?></span></td>

                                                <td <?php if($row['statut']=='Delivring') { ?> >
                                                  <button type="submit" name="track" onclick="tracking()" value="track" style="color:white; font-weight: bold;"> TRACK <?php } ?> </button></td>
                                              ...
                                              <script type="text/javascript">
                                                  function tracking()
                                                  {
                                                   window.location.href('tracked.php'); 
                                                  }
                                              </script>
...
if(distance>=1000)
  $("#msg2").text('The delivery is about  : ' + distance.toFixed(0)/1000 + ' KM away');
else
    $("#msg2").text('The delivery is about  : ' + distance.toFixed(0) + ' M away');
