        ...
        <div id="wrapper">
            ...
            <div class="side-menu left" id="side-menu">
                <ul class="metismenu" id="menu">
                    ...
                    <li class="active">
                        <a href="#"><i class="fa fa-table"></i> <span>Management</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level collapse">
                            <li><a href="table_basic.php">Products</a></li>
                            <li><a href="table_data_tables.php">categorie</a></li>
                        </ul>
                    </li>
                    <li>
                ...
                <div class="content">
                    <div class="container">
                        <div class="page-title">
                            <h3>Products</h3>   
                            <a href="http://127.0.0.1/web/affi.html"></i> Ajouter +</a>

                            <a href="http://127.0.0.1/web/supprimerProduit.php"></i> supprimer -</a>
                            <a href="http://127.0.0.1/web/modif.php"><i class="fa fa-envelope"></i> modification</a>
                            <a href="http://127.0.0.1/web/afficherproduitasc.php"> prix asendant </a>
                             <a href="http://127.0.0.1/web/afficherproduitdesc.php"> prix desendant </a>
                        </div><!--end page title-->
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="panel-box">
...
$listeproduits=$produit1c->afficherproduitasc();
