...
<!-- Mirrored from html.designstream.co.in/pink-desh/dark/table_basic.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 07 Nov 2019 01:41:41 GMT -->
<head>
        ...
        <div id="wrapper">
            ...
            <div class="topbar">
                <div class="topbar-left">
                    <div class="text-center">
                        <a href="../staca/back/views/index.php" class="logo"><img src="images/logo.png" alt=""></a>
                    </div>
                </div>
            ...
            <div class="side-menu left" id="side-menu">
                <ul class="metismenu" id="menu">
                    ...
                    <li class=""><a href="../staca/back/views/index.php"><i class="fa fa-home"></i>  <span>Dashboard</span></a></li>  
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level collapse">
                            ...
                            <ul class="nav nav-third-level">
                                <li>
                                    <a href="../staca/back/views/best_sellers_ever.php">Best Sellers Ever</a>
                                </li>
                                <li>
                                        <a href="../staca/back/views/best_sales_monthly.php">Best Sales MONTHLY</a>
                                </li>
                                <li>
                                        <a href="../staca/back/views/best_sales_weekly.php">Best Sales WEEKLY</a>
                                </li>
                            </ul>
                            <li><i class="fa fa-bar-chart-o"></i> <span>CUSTOMERS STATS</span><span class="fa arrow"></span></li><!-- graph morris-->
                            <ul class="nav nav-third-level">
                                    <li>
                                        <a href="../staca/back/views/Top_customers.php">TOP Customers</a>
                                    </li>
                                    <li>
                                        <a href="../staca/back/views/loyal_customers.php">LOYAL CUSTOMERS</a>
                                    </li>
                                    <li>
                                        <a href="../staca/back/views/over_view_monthly.php">Over Views MONTHLY</a>
                                    </li>
                            </ul>
                            <li><i class="fa fa-bar-chart-o"></i> <span>INCOME STATS</span><span class="fa arrow"></span></li><!-- graph chartjs-->
                            <ul class="nav nav-third-level">
                                    <li>
                                        <a href="../staca/back/views/over_view_total_income.php">Over View Total Income</a>
                                    </li>
                                    <li>
                                        <a href="../staca/back/views/revenue_trois.php">REVENUS 3YRS </a>
                                    </li>
                                    <li>
                                        <a href="../staca/back/views/shipping_stats.php">SHIPPING STATS </a>
                                    </li>
                            </ul>
                    ...
                    <li>
                        <a href="../staca/back/views/commande.php"><i class="fa fa-envelope-o"></i> <span>Commande</span><span class="fa arrow"></span></a>
                    ...
                    <li>
                        <a href="../staca/back/views/ajoutPromo.php"><i class="fa fa-flask"></i> <span class="nav-label">PROMO</span><span class="fa arrow"></span></a>
          
                    </li>


                    <li>
                        <a href="../staca/back/views/checkout_events1.php"><i class="fa fa-flask"></i> <span class="nav-label">EVENT</span><span class="fa arrow"></span></a>
          
                    </li>


                    <li>
                        <a href="../staca/back/views/chat.php"><i class="fa fa-flask"></i> <span class="nav-label">CHAT ROOM</span><span class="fa arrow"></span></a>
                    ...
                    <li>
                                                ...
                                                <ul class="nav nav-second-level collapse">
                            <li><a href="../staca/back/views/livraison.php">Delivery</a></li>
                            <li><a href="../staca/back/views/livreur.php">Delivery_Man</a></li>
                           
                        </ul>
                    </li>

                    <li >
                                                <a href="../staca/back/views/reclamation.php"><i class="fas fa-ban"></i> <span>Reclamation</span><span></span></a>
                ...
                <div class="content">
                    <div class="container">
                        <div class="page-title">
                            <h3>Products</h3>   
                            <a href="affi.html"></i> Ajouter +</a>

                            <a href="supprimerProduit.php"></i> supprimer -</a>
                            <a href="modif.php"><i class="fa fa-envelope"></i> modification</a>
                            <a href="afficherproduitasc.php"> prix asendant </a>
                             <a href="afficherproduitdesc.php"> prix desendant </a>
                        </div><!--end page title-->
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="panel-box">
...
foreach($listeproduits as $row){
    ...
    <td><?PHP echo $row['quantite']; ?> <br> <br><button onclick="print('test.pdf')">Imprimer le PDF</button>
</td>
    <td><img src="image/<?PHP echo $row['image'];  ?>" width="100" height="80"> 
